...
latest_subs_df['logo_start'] = accounts_logos_df['first_start_of_term_y']
latest_subs_df['logo_end'] = accounts_logos_df['last_end_of_term_y']
latest_subs_df['last_gross_mrr'] = accounts_logos_df['gross_mrr_y']
latest_subs_df['last_gross_arr'] = accounts_logos_df['gross_arr_y']
latest_subs_df['last_net_mrr'] = accounts_logos_df['net_mrr_y']
latest_subs_df['last_net_arr'] = accounts_logos_df['net_arr_y']
